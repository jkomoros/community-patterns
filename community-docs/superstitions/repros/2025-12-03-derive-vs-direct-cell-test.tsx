...
export default pattern<Input, { [NAME]: string; [UI]: JSX.Element }>(
  ({ userInput, items, log }) => {
    const SYSTEM =
      "Analyze the sentiment of the text. Return positive, negative, or neutral with confidence 0-1.";
          ...
          >
            ...
            <ul>
              ...
              <li>
                ...
                USE derive() - direct access leaves .result undefined
              </li>
            </ul>
          </div>
            ...
            >
              ...
              >
                ...
                {directMapResults.map((item) => (
                  ...
                  >
                    [{item.id}] pending={item.result.pending ? "T" : "F"},
          ...
          >
            ...
            <ul>
              <li>
                ...
                Result stays "pending" forever despite typing
              </li>
              <li>
                <strong>Undefined result:</strong>{" "}
                pending=false but result=undefined
              </li>
              <li>
                <strong>Working:</strong>{" "}
                pending=false and result has sentiment data
              </li>
            </ul>
          </div>
        </div>
