        ...
        <div style={{ padding: "20px", fontFamily: "system-ui" }}>
          ...
          >
            ...
            <p>
              ...
              Object params DON'T auto-unwrap (need .get())
            </p>
            <p>
              <strong>PR showed:</strong>{" "}
              Runtime DOES auto-unwrap (no .get() needed)
            </p>
            <p>
              <strong>Berni:</strong>{" "}
              "If they're Cell, bug that they get unwrapped... TS and runtime
              shouldn't disagree"
            </p>
          </div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ border: "1px solid #ccc", padding: "8px" }}>
                    {singleResult.hasGet ? "YES (Cell)" : "NO (unwrapped)"}
                  </td>
                </tr>
                <tr>
                  <td style={{ border: "1px solid #ccc", padding: "8px" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ border: "1px solid #ccc", padding: "8px" }}>
                    {objectResult.flagHasGet ? "YES (Cell)" : "NO (unwrapped)"}
                  </td>
                </tr>
                <tr>
                  <td style={{ border: "1px solid #ccc", padding: "8px" }}>
                ...
                <tr>
                  ...
                  <td style={{ border: "1px solid #ccc", padding: "8px" }}>
                    {objectResult.countHasGet ? "YES (Cell)" : "NO (unwrapped)"}
                  </td>
                </tr>
                <tr>
                  <td style={{ border: "1px solid #ccc", padding: "8px" }}>
                  ...
                  <td
                    style={{
                      border: "1px solid #ccc",
                      padding: "8px",
                      background: objectResult.directWorks
                        ? "#c8e6c9"
                        : "#ffcdd2",
                    }}
                  >
          ...
          >
            ...
            <ul>
              <li>
                <strong>hasGet = NO:</strong>{" "}
                Values are auto-unwrapped (runtime disagrees with TS types)
              </li>
              <li>
                <strong>hasGet = YES:</strong>{" "}
                Values are Cells (runtime agrees with TS types)
              </li>
              <li>
                <strong>Direct use works = YES:</strong>{" "}
                Can use values without .get() (auto-unwrapped)
              </li>
            </ul>
          </div>
        </div>
