...
`feature/cf-autocomplete` **Branch (community-patterns):**
`feature/cf-autocomplete` **Prototype:**
...
2. ⬜ Scaffold `cf-autocomplete` component in
...
- **Old PRD**: `patterns/jkomoros/design/todo/cf-search-select-prd.md`
  (superseded)
