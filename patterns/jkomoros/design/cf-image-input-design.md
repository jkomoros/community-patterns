...
This means one `cf-image-input` component can handle all use cases via props,
...
✅ **Single Component** - One `cf-image-input` handles both file upload and
...
`cf-image-editor` if needed later
