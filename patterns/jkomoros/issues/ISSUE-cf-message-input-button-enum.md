...
**Date:** 2025-12-15 **Component:** cf-message-input **Type:** Feature Request
**Priority:** Low (UX polish)

## Summary

The `cf-message-input` component intentionally restricts `buttonText`
...
- Superstition:
  `community-docs/superstitions/2025-12-15-cf-message-input-buttontext-restricted.md`
- Component source:
