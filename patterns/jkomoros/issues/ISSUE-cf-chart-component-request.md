...
charts, sparklines, or other data visualizations. Requesting a `cf-chart`
...
1. **Is adding SVG to JSX.IntrinsicElements feasible?** That would be the
   simplest solution.
2. **Would a cf-chart component be considered?** What's the appetite for
...
4. **Would a simple cf-sparkline be easier to start with?** Limited scope, high
   value.
