...
export default pattern(() => {
  const result = generateObject({
    ...
    system:
      "You are a test assistant. Generate structured data with nested arrays.",
    prompt:
      "Create a test result with 3 items. Each item should have a name and a numeric value.",
  ...
  return {
    ...
    [UI]: (
      <div style={{ padding: "1rem", fontFamily: "system-ui" }}>
        ...
        <p>
          Schema: toSchema&lt;TestResult&gt;() with nested NestedItem[] array
        </p>
