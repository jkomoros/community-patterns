        ...
        >
          ...
          >
            ...
            <p style={{ margin: 0, color: "var(--ct-color-muted)" }}>
              This is the complete UI that shows when viewing the charm
              directly.
            </p>
          </div>
          ...
          >
            ...
            <cf-input $value={title} placeholder="Enter title..." />
          </div>
          ...
          >
            ...
            <cf-textarea $value={content} placeholder="Enter content..." />
          </div>
