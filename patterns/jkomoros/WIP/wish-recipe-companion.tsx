...
interface RecipeCompanionInput {
  foodDescription: Default<
    string,
    "a cheese pizza with tomatoes, basil, and mozzarella"
  >;
      ...
      [UI]: (
        <div style={{ padding: "1rem", maxWidth: "800px" }}>
          ...
          <p style={{ color: "#666", marginBottom: "1rem" }}>
            Describe what you're eating, and I'll suggest a complementary recipe
            using AI-powered pattern discovery.
          </p>
