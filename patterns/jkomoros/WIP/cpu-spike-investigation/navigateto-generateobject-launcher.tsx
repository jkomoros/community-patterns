...
const launchTarget = handler<void, void>(() =>
  navigateTo(
    ExtractTarget({
      notes: "Created via navigateTo - extraction will be slow!",
    }),
  )
);
  ...
  return {
    ...
    [UI]: (
      <div style={{ padding: "1rem", fontFamily: "monospace" }}>
        ...
        >
          <strong>This reproduces a bug:</strong>{" "}
          Click the button below, then run extraction in the target charm. It
          will take ~90 seconds instead of being instant.
        </div>
        ...
        <ul>
          <li>
            <strong>Expected:</strong> Extraction completes in ~2-3 seconds
          </li>
          <li>
            <strong>Actual:</strong> ~90 second CPU spike, then completes
          </li>
        </ul>
        ...
        >
          ...
          patterns/jkomoros/WIP/navigateto-generateobject-target.tsx
        </code>
