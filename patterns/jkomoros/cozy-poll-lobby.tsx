      ...
      [UI]: (
        <div style={{ padding: "1rem", maxWidth: "600px", margin: "0 auto" }}>
          ...
          {computed(() => {
            ...
            if (!ranked || ranked.length === 0 || ranked[0].totalVotes === 0) {
              return null;
            }
            const top = ranked[0];
            const parts: string[] = [];
              ...
              >
                ...
                {ranked.map((item) => (
                  ...
                  >
                    ...
                    >
                      {votesData[item.option.id]?.green?.map((
                        voterName: string,
                      ) => (
                        <span
                          title={voterName}
                      ...
                      {votesData[item.option.id]?.yellow?.map((
                        voterName: string,
                      ) => (
                        <span
                          title={voterName}
                      ...
                      {votesData[item.option.id]?.red?.map((
                        voterName: string,
                      ) => (
                        <span
                          title={voterName}
          ...
          >
            ...
            >
              Create your personal ballot and enter your name. Bookmark your
              ballot URL to return later!
            </div>
            <cf-button
          ...
          >
            <strong>Poll Lobby:</strong>{" "}
            Click the button above to create your personal ballot and vote.
