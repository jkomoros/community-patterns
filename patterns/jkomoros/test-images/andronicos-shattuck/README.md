...
Test images for store mapping feature development. These photos document the
aisle layout and signage of a real grocery store to test:
...
- iOS Safari automatically converts HEIC → JPEG when using
