    ...
    return {
      ...
      [UI]: (
        <div style={{ padding: "1rem", maxWidth: "600px", margin: "0 auto" }}>
          ...
          {ifElse(
            computed(() =>
              !myName || myName.get().trim().length === 0
            ),
          ...
          >
            <strong>Ballot View:</strong>{" "}
            You can vote on options. The poll admin manages options and
            controls.
          </div>
        </div>
      ),
